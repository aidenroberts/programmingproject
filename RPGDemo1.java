...
public class RPGDemo {
    ...
    private static int health, speed, damage;
    private String name;
    private static int level = 1, xp = 0, gold = 0, hPotions = 0, Class;
    ...
    public static void mainMenu() {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                String fileName = "E:\\programmingproject-master\\programmingproject-master\\Software Development Program" + input.next() + ".sav";
                try {
                    ...
                    gold = (Integer)save.readObject();
                    hPotions = (Integer)save.readObject();
                ...
                System.out.println("Health potions: " + hPotions);
                character.showStats();
    ...
    public static void battle() {
        ...
        int Random1 = (25) + (int)(Math.random() * (50 - 25 + 1));
        int Random2 = (50) + (int)(Math.random() * (100 - 50 + 1));
        ...
        if (enemy.health <= 0) {
            ...
            if (enemy.name.equals("a small bear")) {
                ...
                xp += 50;
                System.out.println("You gained " + Random1 + " gold");
                gold += Random1;
            } else {
                System.out.println("You gained 100 xp.");
                xp += 100;
                System.out.println("You gained " + Random2 + " gold");
                gold += Random2;
            }
            System.out.println("Would you like to enter the shop?(Y/N)");
            String shopA;
            shopA = input.nextLine();
            if (shopA == "y"){
                System.out.println("You have entered the shop.");
                System.out.println("1. Health Potion (300 gold)");
    ...
    public static void Save() {
        String fileName = "E:\\programmingproject-master\\programmingproject-master\\Software Development Program" + character.name + ".sav";
        try{
            ...
            save.writeObject(xp);
            save.writeObject(gold);
            save.writeObject(hPotions);
