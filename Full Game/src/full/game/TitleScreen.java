...
public class TitleScreen extends Pane{
    ...
    static class Creation extends Pane{
        ...
        public Creation() {
            ...
            Button glassCanon = new Button("Glass Canon");
            glassCanon.setFont(Font.font("Times", 32));
            glassCanon.setLayoutX(250);
            glassCanon.setLayoutY(400);
            ...
            ivGlassCanon.setFitHeight(75);
            ivGlassCanon.setFitWidth(75);
            ivGlassCanon.setLayoutX(50);
            ivGlassCanon.setLayoutY(glassCanon.getLayoutY());

            getChildren().addAll(warrior, ivWarrior, tank, ivTank, speedster, ivSpeedster, glassCanon, ivGlassCanon);
        }
